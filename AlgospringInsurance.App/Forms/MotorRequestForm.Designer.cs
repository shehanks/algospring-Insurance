...
{
    partial class MotorQuoteRequestForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            VehicleRegistrationBackBrowseLabel = new Label();
            DrivingLicenseBrowseButton = new Button();
            DrivingLicenseBrowsePath = new TextBox();
            DrivingLicenseBrowseLabel = new Label();
            VehicleRegistrationFrontBrowseButton = new Button();
            VehicleRegistrationFrontBrowsePath = new TextBox();
            VehicleRegistrationFrontBrowseLabel = new Label();
            ...
            // 
            MotorQuoteForm_Heading_Label.AutoSize = true;
            MotorQuoteForm_Heading_Label.Font = new Font("Segoe UI", 18F, FontStyle.Bold, GraphicsUnit.Point, 0);
            MotorQuoteForm_Heading_Label.Location = new Point(12, 9);
            MotorQuoteForm_Heading_Label.Name = "MotorQuoteForm_Heading_Label";
            MotorQuoteForm_Heading_Label.Size = new Size(380, 41);
            MotorQuoteForm_Heading_Label.TabIndex = 0;
            MotorQuoteForm_Heading_Label.Text = "Motor Quotation Request";
            // 
            ...
            GeneralInformationGroupBox.Controls.Add(VehicleRegistrationBackBrowseLabel);
            GeneralInformationGroupBox.Controls.Add(DrivingLicenseBrowseButton);
            GeneralInformationGroupBox.Controls.Add(DrivingLicenseBrowsePath);
            GeneralInformationGroupBox.Controls.Add(DrivingLicenseBrowseLabel);
            GeneralInformationGroupBox.Controls.Add(VehicleRegistrationFrontBrowseButton);
            GeneralInformationGroupBox.Controls.Add(VehicleRegistrationFrontBrowsePath);
            GeneralInformationGroupBox.Controls.Add(VehicleRegistrationFrontBrowseLabel);
            ...
            GeneralInformationGroupBox.Controls.Add(VehicleColorLabel);
            GeneralInformationGroupBox.Controls.Add(Gender);
            ...
            GeneralInformationGroupBox.Controls.Add(BusinessNatureLabel);
            GeneralInformationGroupBox.Controls.Add(ProductType);
            GeneralInformationGroupBox.Controls.Add(ProductTypeLabel);
            GeneralInformationGroupBox.Controls.Add(AccountType);
            GeneralInformationGroupBox.Controls.Add(AccountTypeLabel);
            GeneralInformationGroupBox.Controls.Add(CustomerName);
            GeneralInformationGroupBox.Controls.Add(CustomerLabel);
            GeneralInformationGroupBox.Location = new Point(12, 53);
            GeneralInformationGroupBox.Name = "GeneralInformationGroupBox";
            GeneralInformationGroupBox.Size = new Size(1270, 366);
            GeneralInformationGroupBox.TabIndex = 1;
            ...
            VehicleRegistrationBackBrowseButton.Text = "Browse";
            VehicleRegistrationBackBrowseButton.UseVisualStyleBackColor = true;
            // 
            ...
            // 
            // VehicleRegistrationBackBrowseLabel
            // 
            VehicleRegistrationBackBrowseLabel.AutoSize = true;
            VehicleRegistrationBackBrowseLabel.Location = new Point(517, 334);
            VehicleRegistrationBackBrowseLabel.Name = "VehicleRegistrationBackBrowseLabel";
            VehicleRegistrationBackBrowseLabel.Size = new Size(175, 20);
            VehicleRegistrationBackBrowseLabel.TabIndex = 43;
            VehicleRegistrationBackBrowseLabel.Text = "Vehicle Registration Back";
            // 
            ...
            DrivingLicenseBrowseButton.Text = "Browse";
            DrivingLicenseBrowseButton.UseVisualStyleBackColor = true;
            // 
            ...
            // 
            // DrivingLicenseBrowseLabel
            // 
            DrivingLicenseBrowseLabel.AutoSize = true;
            DrivingLicenseBrowseLabel.Location = new Point(6, 330);
            DrivingLicenseBrowseLabel.Name = "DrivingLicenseBrowseLabel";
            DrivingLicenseBrowseLabel.Size = new Size(109, 20);
            DrivingLicenseBrowseLabel.TabIndex = 40;
            DrivingLicenseBrowseLabel.Text = "Driving License";
            // 
            ...
            VehicleRegistrationFrontBrowseButton.Text = "Browse";
            VehicleRegistrationFrontBrowseButton.UseVisualStyleBackColor = true;
            // 
            ...
            // 
            // VehicleRegistrationFrontBrowseLabel
            // 
            VehicleRegistrationFrontBrowseLabel.AutoSize = true;
            VehicleRegistrationFrontBrowseLabel.Location = new Point(517, 301);
            VehicleRegistrationFrontBrowseLabel.Name = "VehicleRegistrationFrontBrowseLabel";
            VehicleRegistrationFrontBrowseLabel.Size = new Size(178, 20);
            VehicleRegistrationFrontBrowseLabel.TabIndex = 37;
            VehicleRegistrationFrontBrowseLabel.Text = "Vehicle Registration Front";
            // 
            ...
            EmiratesIdBrowseButton.Text = "Browse";
            EmiratesIdBrowseButton.UseVisualStyleBackColor = true;
            // 
            ...
            // 
            // EmiratesIdBrowseLabel
            // 
            EmiratesIdBrowseLabel.AutoSize = true;
            EmiratesIdBrowseLabel.Location = new Point(6, 297);
            EmiratesIdBrowseLabel.Name = "EmiratesIdBrowseLabel";
            EmiratesIdBrowseLabel.Size = new Size(83, 20);
            ...
            GenderLabel.Location = new Point(6, 68);
            ...
            // PolicyStartDate
            // 
            PolicyStartDate.CustomFormat = "dd/MM/yyyy";
            PolicyStartDate.Format = DateTimePickerFormat.Custom;
            PolicyStartDate.Location = new Point(130, 234);
            PolicyStartDate.MinDate = new DateTime(2024, 7, 1, 17, 31, 4, 743);
            ...
            PolicyStartDateLabel.Location = new Point(6, 239);
            PolicyStartDateLabel.Name = "PolicyStartDateLabel";
            PolicyStartDateLabel.Size = new Size(118, 20);
            PolicyStartDateLabel.TabIndex = 10;
            PolicyStartDateLabel.Text = "Policy Start Date";
            // 
            // BusinessNature
            // 
            BusinessNature.FormattingEnabled = true;
            BusinessNature.Location = new Point(130, 199);
            BusinessNature.Name = "BusinessNature";
            BusinessNature.Size = new Size(200, 28);
            BusinessNature.TabIndex = 7;
            // 
            // BusinessNatureLabel
            // 
            BusinessNatureLabel.AutoSize = true;
            BusinessNatureLabel.Location = new Point(6, 202);
            BusinessNatureLabel.Name = "BusinessNatureLabel";
            BusinessNatureLabel.Size = new Size(113, 20);
            BusinessNatureLabel.TabIndex = 6;
            BusinessNatureLabel.Text = "Business Nature";
            // 
            // ProductType
            // 
            ProductType.FormattingEnabled = true;
            ProductType.Location = new Point(130, 165);
            ProductType.Name = "ProductType";
            ProductType.Size = new Size(200, 28);
            ProductType.TabIndex = 5;
            // 
            // ProductTypeLabel
            // 
            ProductTypeLabel.AutoSize = true;
            ProductTypeLabel.Location = new Point(6, 168);
            ProductTypeLabel.Name = "ProductTypeLabel";
            ProductTypeLabel.Size = new Size(95, 20);
            ...
            AccountType.Location = new Point(130, 131);
            AccountType.Name = "AccountType";
            AccountType.Size = new Size(200, 28);
            AccountType.TabIndex = 3;
            // 
            // AccountTypeLabel
            // 
            AccountTypeLabel.AutoSize = true;
            AccountTypeLabel.Location = new Point(6, 134);
            AccountTypeLabel.Name = "AccountTypeLabel";
            AccountTypeLabel.Size = new Size(98, 20);
            AccountTypeLabel.TabIndex = 2;
            ...
            PortalPanel.BorderStyle = BorderStyle.FixedSingle;
            PortalPanel.Controls.Add(OutputPortalIsNewIndia);
            PortalPanel.Controls.Add(OutputPortalIsFidelity);
            PortalPanel.Controls.Add(OutputPortalOriental);
            PortalPanel.Controls.Add(OutputPortalIsSukoon);
            PortalPanel.Controls.Add(OutputPortalIsTokio);
            PortalPanel.Controls.Add(OutputPortalIsRak);
            PortalPanel.Controls.Add(OutputPortalIsAlsagar);
            PortalPanel.Location = new Point(6, 30);
            PortalPanel.Name = "PortalPanel";
            ...
            // 
            OutputPortalIsFidelity.AutoSize = true;
            OutputPortalIsFidelity.Location = new Point(190, 47);
            OutputPortalIsFidelity.Name = "OutputPortalIsFidelity";
            OutputPortalIsFidelity.Size = new Size(88, 24);
            OutputPortalIsFidelity.TabIndex = 5;
            ...
            // groupBox1
            // 
            groupBox1.Controls.Add(OutputDateOfBirth);
            groupBox1.Controls.Add(OutputDateOfBirthLabel);
            groupBox1.Controls.Add(OutputNationality);
            groupBox1.Controls.Add(OutputNationalityLabel);
            groupBox1.Controls.Add(OutputEmiratesExpiryDate);
            groupBox1.Controls.Add(OutputEmiratesExpiryDateLabel);
            groupBox1.Controls.Add(OutputEmiratesIssueDate);
            groupBox1.Controls.Add(OutputEmiratesIssueDateLabel);
            groupBox1.Controls.Add(OutputEmiratesId);
            groupBox1.Controls.Add(OutputEmiratesIdLabel);
            groupBox1.Location = new Point(440, 197);
            groupBox1.Name = "groupBox1";
            groupBox1.Size = new Size(364, 203);
            ...
            // 
            OutputEmiratesExpiryDate.CustomFormat = "dd/MM/yyyy";
            OutputEmiratesExpiryDate.Format = DateTimePickerFormat.Custom;
            OutputEmiratesExpiryDate.Location = new Point(106, 165);
            OutputEmiratesExpiryDate.MinDate = new DateTime(2024, 7, 1, 17, 31, 4, 743);
            ...
            // 
            OutputEmiratesExpiryDateLabel.AutoSize = true;
            OutputEmiratesExpiryDateLabel.Location = new Point(6, 170);
            OutputEmiratesExpiryDateLabel.Name = "OutputEmiratesExpiryDateLabel";
            OutputEmiratesExpiryDateLabel.Size = new Size(85, 20);
            OutputEmiratesExpiryDateLabel.TabIndex = 63;
            OutputEmiratesExpiryDateLabel.Text = "Expiry Date";
            // 
            // OutputEmiratesIssueDate
            // 
            OutputEmiratesIssueDate.CustomFormat = "dd/MM/yyyy";
            OutputEmiratesIssueDate.Format = DateTimePickerFormat.Custom;
            OutputEmiratesIssueDate.Location = new Point(106, 132);
            OutputEmiratesIssueDate.MinDate = new DateTime(2024, 7, 1, 17, 31, 4, 743);
            ...
            // 
            OutputEmiratesIssueDateLabel.AutoSize = true;
            OutputEmiratesIssueDateLabel.Location = new Point(6, 137);
            OutputEmiratesIssueDateLabel.Name = "OutputEmiratesIssueDateLabel";
            OutputEmiratesIssueDateLabel.Size = new Size(77, 20);
            OutputEmiratesIssueDateLabel.TabIndex = 47;
            OutputEmiratesIssueDateLabel.Text = "Issue Date";
            // 
            // OutputEmiratesId
            // 
            OutputEmiratesId.Location = new Point(106, 31);
            OutputEmiratesId.Name = "OutputEmiratesId";
            OutputEmiratesId.Size = new Size(200, 27);
            OutputEmiratesId.TabIndex = 48;
            // 
            // OutputEmiratesIdLabel
            // 
            OutputEmiratesIdLabel.AutoSize = true;
            OutputEmiratesIdLabel.Location = new Point(6, 31);
            OutputEmiratesIdLabel.Name = "OutputEmiratesIdLabel";
            OutputEmiratesIdLabel.Size = new Size(83, 20);
            ...
            // OutputInsExpDate
            // 
            OutputInsExpDate.CustomFormat = "dd/MM/yyyy";
            OutputInsExpDate.Format = DateTimePickerFormat.Custom;
            OutputInsExpDate.Location = new Point(123, 328);
            OutputInsExpDate.MinDate = new DateTime(2024, 7, 1, 17, 31, 4, 743);
        ...
        private Label MotorQuoteForm_Heading_Label;
        ...
        private Label PlateCategoryLabel;
        private ComboBox GCCSpec;
        ...
        private Button VehicleRegistrationBackBrowseButton;
        private TextBox VehicleRegistrationBackBrowsePath;
        private Label VehicleRegistrationBackBrowseLabel;
        private Button DrivingLicenseBrowseButton;
        private TextBox DrivingLicenseBrowsePath;
        private Label DrivingLicenseBrowseLabel;
        ...
        private CheckBox OutputPortalIsSukoon;
        private CheckBox OutputPortalIsTokio;
        private CheckBox OutputPortalIsRak;
        private CheckBox OutputPortalIsNewIndia;
        private CheckBox OutputPortalIsFidelity;
        private GroupBox OutputVehicleDetailsGroupBox;
        private TextBox OutputTrafficPlateNo;
        private Label OutputTrafficPlateNoLabel;
        private TextBox OutputVehicleModel;
        private Label OutputVehicleModelLabel;
        private TextBox OutputTCNo;
        ...
        private DateTimePicker OutputEmiratesExpiryDate;
        private Label OutputEmiratesExpiryDateLabel;
        private DateTimePicker OutputEmiratesIssueDate;
        private Label OutputEmiratesIssueDateLabel;
        private TextBox OutputEmiratesId;
        private Label OutputEmiratesIdLabel;
        private DateTimePicker OutputDateOfBirth;
        private Label OutputDateOfBirthLabel;
        private DateTimePicker OutputInsExpDate;
        private Label OutputInsExpDateLabel;
        private DateTimePicker OutputRegisterDate;
        private Label OutputRegisterDateLabel;
        private TextBox OutputVehicleMake;
        private Label OutputMakeLabel;
        private TextBox OutputVehicleOrigin;
        private Label OutputOriginLabel;
        private TextBox OutputModelYear;
        private Label OutputModelYearLabel;
        private GroupBox groupBox2;
        private ComboBox OutputPlaceOfIssue;
        private Label OutputPlaceOfIssueLabel;
        private DateTimePicker OutputDrivingLicenseExpiryDate;
        private Label OutputDrivingLicenseExpiryDateLabel;
        private DateTimePicker OutputDrivingLicenseIssueDate;
        private Label OutputDrivingLicenseIssueDateLabel;
        private TextBox OutputLicenseNo;
        private Label OutputLicenseNoLabel;
